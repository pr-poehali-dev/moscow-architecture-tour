...
const SECTION_CARDS = [
  ...
  },
  {
    id: 'objects',
    title: 'Объекты',
    subtitle: '10 памятников',
    desc: '6 объектов барокко и 5 объектов классицизма — с вкладками, иллюстрациями и историческими сводками',
    icon: '🏗',
    color: '#8B1A1A',
  },
  {
    id: 'routes',
    title: 'Маршруты',
    subtitle: 'Два маршрута',
    desc: 'Барокко и классицизм: пешеходные маршруты с историческими сводками и подсказками как добраться',
    icon: '🗺️',
    color: '#8B1A1A',
  },
  {
    ...
    desc: 'Десять памятников архитектуры Москвы XVIII века на единой интерактивной карте города',
    icon: '📍',
    color: '#5C4B2A',
  },
  {
    id: 'about',
    title: 'О проекте',
    subtitle: 'Описание и библиография',
    desc: 'О сайте и список научных источников, оформленных по ГОСТ',
    icon: 'ℹ️',
    color: '#444',
  },
];
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                { num: '10', label: 'Памятников архитектуры' },
                { num: '2', label: 'Архитектурных маршрута' },
                { num: '100', label: 'Лет истории города' },
                { num: '2', label: 'Архитектурных стиля' },
              ].map((stat) => (
